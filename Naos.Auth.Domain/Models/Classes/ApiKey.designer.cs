...
namespace Naos.Auth.Domain
{
    ...
    [Serializable]
    public partial class ApiKey : IModel<ApiKey>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="ApiKey"/> are equal.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="ApiKey"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as ApiKey);
        ...
        /// <returns>New <see cref="ApiKey" /> using the specified <paramref name="value" /> for <see cref="Value" /> and a deep clone of every other property.</returns>
        ...
        public ApiKey DeepCloneWithValue(string value)
        {
            var result = new ApiKey(
                                 value);
        ...
        {
            var result = Invariant($"Naos.Auth.Domain.ApiKey: Value = {this.Value?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
