...
namespace Naos.Auth.Domain
{
    ...
    [Serializable]
    public partial class TokenInfo : IModel<TokenInfo>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="TokenInfo"/> are equal.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="TokenInfo"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(TokenInfo left, TokenInfo right) => !(left == right);
        ...
        public bool Equals(TokenInfo other)
        {
            ...
            var result = this.Token.IsEqualTo(other.Token, StringComparer.Ordinal)
                      && this.Validity.IsEqualTo(other.Validity);

            return result;
        }

        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as TokenInfo);
        ...
        /// <returns>New <see cref="TokenInfo" /> using the specified <paramref name="token" /> for <see cref="Token" /> and a deep clone of every other property.</returns>
        ...
        public TokenInfo DeepCloneWithToken(string token)
        {
            var result = new TokenInfo(
                                 token,
                                 this.Validity?.DeepClone());
        ...
        /// <returns>New <see cref="TokenInfo" /> using the specified <paramref name="validity" /> for <see cref="Validity" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public TokenInfo DeepCloneWithValidity(UtcDateTimeRangeInclusive validity)
        {
            var result = new TokenInfo(
                                 this.Token?.DeepClone(),
                                 validity);
        ...
        {
            var result = Invariant($"Naos.Auth.Domain.TokenInfo: Token = {this.Token?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Validity = {this.Validity?.ToString() ?? "<null>"}.");
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.Validity, options, propertyPathTracker, nameof(this.Validity));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
