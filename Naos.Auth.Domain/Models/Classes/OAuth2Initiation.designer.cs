...
namespace Naos.Auth.Domain
{
    ...
    [Serializable]
    public partial class OAuth2Initiation : IModel<OAuth2Initiation>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="OAuth2Initiation"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(OAuth2Initiation left, OAuth2Initiation right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="OAuth2Initiation"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(OAuth2Initiation left, OAuth2Initiation right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(OAuth2Initiation other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as OAuth2Initiation);
        ...
        /// <inheritdoc />
        public OAuth2Initiation DeepClone()
        {
        ...
        /// <summary>
        /// Deep clones this object with a new <see cref="AuthorizationUrl" />.
        /// </summary>
        /// <param name="authorizationUrl">The new <see cref="AuthorizationUrl" />.  This object will NOT be deep cloned; it is used as-is.</param>
        /// <returns>New <see cref="OAuth2Initiation" /> using the specified <paramref name="authorizationUrl" /> for <see cref="AuthorizationUrl" /> and a deep clone of every other property.</returns>
        ...
        public OAuth2Initiation DeepCloneWithAuthorizationUrl(string authorizationUrl)
        {
            var result = new OAuth2Initiation(
                                 authorizationUrl,
                                 this.CsrfValidationState?.DeepClone());
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.AuthorizationUrl, options, propertyPathTracker, nameof(this.AuthorizationUrl));
