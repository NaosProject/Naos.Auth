...
namespace Naos.Auth.Domain
{
    ...
    [Serializable]
    public partial class RevokeOAuth2TokenOp : IModel<RevokeOAuth2TokenOp>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="RevokeOAuth2TokenOp"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(RevokeOAuth2TokenOp left, RevokeOAuth2TokenOp right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="RevokeOAuth2TokenOp"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(RevokeOAuth2TokenOp left, RevokeOAuth2TokenOp right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(RevokeOAuth2TokenOp other)
        {
            ...
            var result = this.ConnectionInfo.IsEqualTo(other.ConnectionInfo)
                      && this.Token.IsEqualTo(other.Token);

            return result;
        }

        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as RevokeOAuth2TokenOp);
        ...
        /// <inheritdoc />
        public new RevokeOAuth2TokenOp DeepClone() => (RevokeOAuth2TokenOp)this.DeepCloneInternal();
        ...
        /// <returns>New <see cref="RevokeOAuth2TokenOp" /> using the specified <paramref name="connectionInfo" /> for <see cref="ConnectionInfo" /> and a deep clone of every other property.</returns>
        ...
        public RevokeOAuth2TokenOp DeepCloneWithConnectionInfo(OAuth2ConnectionInfo connectionInfo)
        {
            var result = new RevokeOAuth2TokenOp(
                                 connectionInfo,
                                 this.Token?.DeepClone());

            return result;
        }

        /// <summary>
        /// Deep clones this object with a new <see cref="Token" />.
        /// </summary>
        /// <param name="token">The new <see cref="Token" />.  This object will NOT be deep cloned; it is used as-is.</param>
        /// <returns>New <see cref="RevokeOAuth2TokenOp" /> using the specified <paramref name="token" /> for <see cref="Token" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public RevokeOAuth2TokenOp DeepCloneWithToken(TokenInfo token)
        {
            var result = new RevokeOAuth2TokenOp(
        ...
        {
            var result = Invariant($"Naos.Auth.Domain.RevokeOAuth2TokenOp: ConnectionInfo = {this.ConnectionInfo?.ToString() ?? "<null>"}, Token = {this.Token?.ToString() ?? "<null>"}.");
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.Token, options, propertyPathTracker, nameof(this.Token));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
