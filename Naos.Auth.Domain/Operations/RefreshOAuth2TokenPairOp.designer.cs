...
namespace Naos.Auth.Domain
{
    ...
    [Serializable]
    public partial class RefreshOAuth2TokenPairOp : IModel<RefreshOAuth2TokenPairOp>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="RefreshOAuth2TokenPairOp"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(RefreshOAuth2TokenPairOp left, RefreshOAuth2TokenPairOp right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="RefreshOAuth2TokenPairOp"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(RefreshOAuth2TokenPairOp left, RefreshOAuth2TokenPairOp right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(RefreshOAuth2TokenPairOp other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as RefreshOAuth2TokenPairOp);
        ...
        /// <inheritdoc />
        public new RefreshOAuth2TokenPairOp DeepClone() => (RefreshOAuth2TokenPairOp)this.DeepCloneInternal();

        /// <summary>
        /// Deep clones this object with a new <see cref="ConnectionInfo" />.
        /// </summary>
        /// <param name="connectionInfo">The new <see cref="ConnectionInfo" />.  This object will NOT be deep cloned; it is used as-is.</param>
        /// <returns>New <see cref="RefreshOAuth2TokenPairOp" /> using the specified <paramref name="connectionInfo" /> for <see cref="ConnectionInfo" /> and a deep clone of every other property.</returns>
        ...
        public RefreshOAuth2TokenPairOp DeepCloneWithConnectionInfo(OAuth2ConnectionInfo connectionInfo)
        {
        ...
        /// <returns>New <see cref="RefreshOAuth2TokenPairOp" /> using the specified <paramref name="refreshToken" /> for <see cref="RefreshToken" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public RefreshOAuth2TokenPairOp DeepCloneWithRefreshToken(TokenInfo refreshToken)
        {
            var result = new RefreshOAuth2TokenPairOp(
        ...
        {
            var result = Invariant($"Naos.Auth.Domain.RefreshOAuth2TokenPairOp: ConnectionInfo = {this.ConnectionInfo?.ToString() ?? "<null>"}, RefreshToken = {this.RefreshToken?.ToString() ?? "<null>"}.");
