...
namespace Naos.Auth.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<GetOAuth2InitiationOpExecutedEvent> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<GetOAuth2InitiationOpExecutedEvent>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<GetOAuth2InitiationOpExecutedEvent>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<GetOAuth2InitiationOpExecutedEvent> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<GetOAuth2InitiationOpExecutedEvent>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<GetOAuth2InitiationOpExecutedEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<GetOAuth2InitiationOpExecutedEvent>().ThatIs(_ => !systemUnderTest.TimestampUtc.IsEqualTo(_.TimestampUtc));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<GetOAuth2InitiationOpExecutedEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<GetOAuth2InitiationOpExecutedEvent>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));
        ...
        private static readonly EquatableTestScenarios<GetOAuth2InitiationOpExecutedEvent> EquatableTestScenarios = new EquatableTestScenarios<GetOAuth2InitiationOpExecutedEvent>()
            .AddScenario(() =>
                new EquatableTestScenario<GetOAuth2InitiationOpExecutedEvent>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new GetOAuth2InitiationOpExecutedEvent[]
                    {
        ...
        private static readonly ValidModelTestScenarios<GetOAuth2InitiationOpExecutedEvent> ValidModelTestScenarios = new ValidModelTestScenarios<GetOAuth2InitiationOpExecutedEvent>()
            .AddScenario(() =>
                new ValidModelTestScenario<GetOAuth2InitiationOpExecutedEvent>
                {
                    Name = "a dummy GetOAuth2InitiationOpExecutedEvent should be valid",
                    SystemUnderTest = A.Dummy<GetOAuth2InitiationOpExecutedEvent>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void GetOAuth2InitiationOpExecutedEvent___Should_implement_IModel_of_GetOAuth2InitiationOpExecutedEvent___When_reflecting()
            {
                // Arrange
                var type = typeof(GetOAuth2InitiationOpExecutedEvent);

                var expectedModelMethods = typeof(IModel<GetOAuth2InitiationOpExecutedEvent>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<GetOAuth2InitiationOpExecutedEvent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void GetOAuth2InitiationOpExecutedEvent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(GetOAuth2InitiationOpExecutedEvent);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (GetOAuth2InitiationOpExecutedEvent)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (GetOAuth2InitiationOpExecutedEvent)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(GetOAuth2InitiationOpExecutedEvent).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<GetOAuth2InitiationOpExecutedEvent>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                GetOAuth2InitiationOpExecutedEvent systemUnderTest1 = null;
                GetOAuth2InitiationOpExecutedEvent systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    GetOAuth2InitiationOpExecutedEvent systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetOAuth2InitiationOpExecutedEvent___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetOAuth2InitiationOpExecutedEvent___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetOAuth2InitiationOpExecutedEvent___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetOAuth2InitiationOpExecutedEvent___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetOAuth2InitiationOpExecutedEvent___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
