...
namespace Naos.Auth.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<OAuth2Initiation> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<OAuth2Initiation>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<OAuth2Initiation>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<OAuth2Initiation> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<OAuth2Initiation>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<OAuth2Initiation>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'authorizationUrl' is null scenario",
                    ConstructionFunc = () =>
                    {
                    ...
                    ExpectedExceptionMessageContains = new[] { "authorizationUrl", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<OAuth2Initiation>
                {
                    Name = "constructor should throw ArgumentException when parameter 'authorizationUrl' is white space scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<OAuth2Initiation>();
                    ...
                    ExpectedExceptionMessageContains = new[] { "authorizationUrl", "white space", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<OAuth2Initiation>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<OAuth2Initiation> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<OAuth2Initiation>()
            .AddScenario(() =>
                ...
                {
                    Name = "AuthorizationUrl should return same 'authorizationUrl' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<OAuth2Initiation>();

                        var result = new SystemUnderTestExpectedPropertyValue<OAuth2Initiation>
                        {
        ...
        private static readonly DeepCloneWithTestScenarios<OAuth2Initiation> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<OAuth2Initiation>()
            .AddScenario(() =>
                ...
                {
                    Name = "DeepCloneWithAuthorizationUrl should deep clone object and replace AuthorizationUrl with the provided authorizationUrl",
                    WithPropertyName = "AuthorizationUrl",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<OAuth2Initiation>();

                        var referenceObject = A.Dummy<OAuth2Initiation>().ThatIs(_ => !systemUnderTest.AuthorizationUrl.IsEqualTo(_.AuthorizationUrl));

                        var result = new SystemUnderTestDeepCloneWithValue<OAuth2Initiation>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.AuthorizationUrl,
                        };
        ...
        private static readonly OAuth2Initiation ReferenceObjectForEquatableTestScenarios = A.Dummy<OAuth2Initiation>();

        private static readonly EquatableTestScenarios<OAuth2Initiation> EquatableTestScenarios = new EquatableTestScenarios<OAuth2Initiation>()
            .AddScenario(() =>
                new EquatableTestScenario<OAuth2Initiation>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new OAuth2Initiation[]
                    {
        ...
        private static readonly ValidModelTestScenarios<OAuth2Initiation> ValidModelTestScenarios = new ValidModelTestScenarios<OAuth2Initiation>()
            .AddScenario(() =>
                new ValidModelTestScenario<OAuth2Initiation>
                {
                    Name = "a dummy OAuth2Initiation should be valid",
                    SystemUnderTest = A.Dummy<OAuth2Initiation>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void OAuth2Initiation___Should_implement_IModel_of_OAuth2Initiation___When_reflecting()
            {
                // Arrange
                var type = typeof(OAuth2Initiation);

                var expectedModelMethods = typeof(IModel<OAuth2Initiation>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<OAuth2Initiation>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void OAuth2Initiation___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(OAuth2Initiation);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (OAuth2Initiation)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (OAuth2Initiation)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(OAuth2Initiation).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<OAuth2Initiation>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                OAuth2Initiation systemUnderTest1 = null;
                OAuth2Initiation systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    OAuth2Initiation systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_OAuth2Initiation___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_OAuth2Initiation___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_OAuth2Initiation___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_OAuth2Initiation___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_OAuth2Initiation___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
