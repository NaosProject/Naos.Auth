...
namespace Naos.Auth.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<TokenInfo> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<TokenInfo>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<TokenInfo>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<TokenInfo>();

                        var result = new SystemUnderTestExpectedStringRepresentation<TokenInfo>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Auth.Domain.TokenInfo: Token = {systemUnderTest.Token?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Validity = {systemUnderTest.Validity?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<TokenInfo> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<TokenInfo>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<TokenInfo>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'token' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<TokenInfo>();
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<TokenInfo>
                {
                    Name = "constructor should throw ArgumentException when parameter 'token' is white space scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<TokenInfo>();
                    ...
                    ExpectedExceptionMessageContains = new[] { "token", "white space", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<TokenInfo>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'validity' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<TokenInfo>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "validity", },
                });

        private static readonly ConstructorPropertyAssignmentTestScenarios<TokenInfo> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<TokenInfo>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<TokenInfo>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<TokenInfo>
                        {
                            SystemUnderTest = new TokenInfo(
                                                      referenceObject.Token,
                                                      referenceObject.Validity),
        ...
        private static readonly DeepCloneWithTestScenarios<TokenInfo> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<TokenInfo>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TokenInfo>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<TokenInfo>().ThatIs(_ => !systemUnderTest.Token.IsEqualTo(_.Token));

                        var result = new SystemUnderTestDeepCloneWithValue<TokenInfo>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TokenInfo>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<TokenInfo>().ThatIs(_ => !systemUnderTest.Validity.IsEqualTo(_.Validity));
        ...
        private static readonly TokenInfo ReferenceObjectForEquatableTestScenarios = A.Dummy<TokenInfo>();

        private static readonly EquatableTestScenarios<TokenInfo> EquatableTestScenarios = new EquatableTestScenarios<TokenInfo>()
            .AddScenario(() =>
                new EquatableTestScenario<TokenInfo>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new TokenInfo[]
                    {
                        new TokenInfo(
                                ReferenceObjectForEquatableTestScenarios.Token,
                                ReferenceObjectForEquatableTestScenarios.Validity),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new TokenInfo[]
                    {
                        new TokenInfo(
                                A.Dummy<TokenInfo>().Whose(_ => !_.Token.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Token)).Token,
                                ReferenceObjectForEquatableTestScenarios.Validity),
                        new TokenInfo(
                                ReferenceObjectForEquatableTestScenarios.Token,
                                A.Dummy<TokenInfo>().Whose(_ => !_.Validity.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Validity)).Validity),
                    },
        ...
        private static readonly ValidModelTestScenarios<TokenInfo> ValidModelTestScenarios = new ValidModelTestScenarios<TokenInfo>()
            .AddScenario(() =>
                new ValidModelTestScenario<TokenInfo>
                {
                    Name = "a dummy TokenInfo should be valid",
                    SystemUnderTest = A.Dummy<TokenInfo>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void TokenInfo___Should_implement_IModel_of_TokenInfo___When_reflecting()
            {
                // Arrange
                var type = typeof(TokenInfo);

                var expectedModelMethods = typeof(IModel<TokenInfo>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<TokenInfo>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void TokenInfo___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(TokenInfo);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (TokenInfo)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.Validity == null)
                {
                    actual.Validity.AsTest().Must().BeNull();
                }
                else if (!actual.Validity.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.Validity.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.Validity);
                }
            }
            ...
            {
                var propertyNames = new string[] { "Token", "Validity" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (TokenInfo)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(TokenInfo).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<TokenInfo>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                TokenInfo systemUnderTest1 = null;
                TokenInfo systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    TokenInfo systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TokenInfo___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TokenInfo___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TokenInfo___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TokenInfo___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TokenInfo___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
