...
namespace Naos.Auth.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<ApiKey> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<ApiKey>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<ApiKey>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ApiKey>();

                        var result = new SystemUnderTestExpectedStringRepresentation<ApiKey>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Auth.Domain.ApiKey: Value = {systemUnderTest.Value?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<ApiKey> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<ApiKey>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ApiKey>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<ApiKey> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<ApiKey>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ApiKey>
                {
                    Name = "Value should return same 'value' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<ApiKey>();

                        var result = new SystemUnderTestExpectedPropertyValue<ApiKey>
                        {
                            SystemUnderTest = new ApiKey(
        ...
        private static readonly DeepCloneWithTestScenarios<ApiKey> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<ApiKey>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ApiKey>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ApiKey>().ThatIs(_ => !systemUnderTest.Value.IsEqualTo(_.Value));

                        var result = new SystemUnderTestDeepCloneWithValue<ApiKey>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly ApiKey ReferenceObjectForEquatableTestScenarios = A.Dummy<ApiKey>();

        private static readonly EquatableTestScenarios<ApiKey> EquatableTestScenarios = new EquatableTestScenarios<ApiKey>()
            .AddScenario(() =>
                new EquatableTestScenario<ApiKey>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ApiKey[]
                    {
                        new ApiKey(
                                ReferenceObjectForEquatableTestScenarios.Value),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new ApiKey[]
                    {
                        new ApiKey(
                                A.Dummy<ApiKey>().Whose(_ => !_.Value.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Value)).Value),
                    },
        ...
        private static readonly ValidModelTestScenarios<ApiKey> ValidModelTestScenarios = new ValidModelTestScenarios<ApiKey>()
            .AddScenario(() =>
                new ValidModelTestScenario<ApiKey>
                {
                    Name = "a dummy ApiKey should be valid",
                    SystemUnderTest = A.Dummy<ApiKey>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void ApiKey___Should_implement_IModel_of_ApiKey___When_reflecting()
            {
                // Arrange
                var type = typeof(ApiKey);

                var expectedModelMethods = typeof(IModel<ApiKey>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ApiKey>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ApiKey___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ApiKey);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (ApiKey)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (ApiKey)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(ApiKey).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                ApiKey systemUnderTest1 = null;
                ApiKey systemUnderTest2 = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ApiKey___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ApiKey___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ApiKey___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ApiKey___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ApiKey___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
